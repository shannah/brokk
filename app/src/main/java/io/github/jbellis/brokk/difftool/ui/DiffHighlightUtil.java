...
public final class DiffHighlightUtil {
    ...
    /**
     * Returns the chunk to use for highlighting purposes. For DELETE deltas on the revised side, creates a fallback
     * chunk at the insertion point to show where content was removed.
     */
