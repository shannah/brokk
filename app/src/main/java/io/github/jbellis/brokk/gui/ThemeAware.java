 ...
 * delegate the work to them while walking the Swing component tree.
 */
public interface ThemeAware {
     ...
     *
     * @param guiTheme reference to the central theme manager (handy for delegating to helper methods such as
