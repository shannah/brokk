...
public record EditBlockComponentData(int id, int adds, int dels, int changed, String file, GitStatus status)
    ...
    public void updateComponent(JComponent component) {
        if (component instanceof JPanel panel) {
            ...
            Color expectedBgColor = darkTheme
                    ? ThemeColors.getColor(true, "code_block_background")
                    : ThemeColors.getColor(false, "message_background");
