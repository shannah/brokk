...
/**
 * Encapsulates the choices made by the user in the ArchitectOptionsDialog, including both the agent's operational
 * options and whether to run in a new Git worktree.
 *
