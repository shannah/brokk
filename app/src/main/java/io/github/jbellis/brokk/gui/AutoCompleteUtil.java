...
public class AutoCompleteUtil {
    ...
    /**
     * Binds Ctrl+Enter to accept the current autocomplete suggestion if the popup is visible; if the autocomplete popup
     * is not open, it submits the dialog by triggering its default button.
     *
    ...
    public static void bindCtrlEnter(AutoCompletion autoCompletion, JTextComponent textComponent) {
        ...
        textComponent.getActionMap().put("ctrlEnterAction", new AbstractAction() {
            @Override
    ...
    /**
     * Dynamically adjusts the size of the AutoCompletion popup windows (choices and description) based on the content
     * of the completions.
     *
    ...
    public static void sizePopupWindows(
            AutoCompletion autoCompletion, JTextComponent textComponent, List<ShorthandCompletion> completions) {
