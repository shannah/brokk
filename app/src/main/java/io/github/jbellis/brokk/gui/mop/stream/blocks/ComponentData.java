...
/**
 * Represents a component that can be rendered in the UI. Each component has a stable ID and a fingerprint for change
 * detection.
 */
public sealed interface ComponentData
    ...
    /**
     * Updates an existing component with this data. Implementations should preserve caret position and scroll state
     * when possible.
     *
