...
/** A simple panel displaying a spinner icon and a message. Handles its own background color based on the theme. */
public class SpinnerIndicatorPanel extends JPanel {
    ...
    public SpinnerIndicatorPanel(String message, boolean isDarkTheme, @Nullable Color backgroundColor) {
        ...
        var spinnerIcon = new ImageIcon(Objects.requireNonNull(
                getClass().getResource("/icons/" + (isDarkTheme ? "spinner_dark.gif" : "spinner_white.gif"))));
