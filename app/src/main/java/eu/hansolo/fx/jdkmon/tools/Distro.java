...
public class Distro {
    ...
    public Distro(
            ...
            final String jdkMajorVersion,
            final String operatingSystem,
            final String architecture,
            final Boolean fxBundled,
            final String location,
            final Feature feature,
            final BuildScope buildScope,
            final boolean handledBySdkman,
            final String path) {
        this.name = name;
    ...
    public String getJdkMajorVersion() {
    ...
    public BuildScope getBuildScope() {
        return buildScope;
    }
    ...
    public boolean isHandledBySdkman() {
        return handledBySdkman;
    }
    ...
    public boolean supportsCRaC() {
        return this.supportsCRaC;
    }

    public void setSupportsCRaC(final boolean supportsCRaC) {
        this.supportsCRaC = supportsCRaC;
    }
    ...
    public Optional<LocalDateTime> getEndOfLifeDate() {
        return this.endOfLifeDate;
    }

    public void setEndOfLifeDate(final LocalDateTime endOfLifeDate) {
        this.endOfLifeDate = Optional.of(endOfLifeDate);
    }

    public String getModulesText(final boolean includeModules) {
        if (getVersionNumber().getFeature().isPresent()) {
            if (getVersionNumber().getFeature().getAsInt() < 9) {
                return "(No modular JDK)";
            }
        }
    ...
    public String toString() {
        return new StringBuilder()
                ...
                .append(getVersion())
                .append("\",")
                .append("\"operating_system\":\"")
                .append(getOperatingSystem())
                .append("\",")
                .append("\"architecture\":\"")
                .append(getArchitecture())
                .append("\",")
                .append("\"fx\":\"")
                .append(getFxBundled())
                .append("\",")
                ...
                .append(getFeature())
                .append("\",")
                .append("\"handled_by_sdkman\":")
                .append(isHandledBySdkman())
                .append(",")
                .append("\"path\":\"")
                .append(path)
                .append("\",")
                ...
                .append(isInUse())
                .append(",")
                .append("\"supports_crac\":")
                .append(supportsCRaC())
                .append(",")
                .append("\"modules\":\"")
                .append(getModulesText(true))
                .append("\"")
                .append("}")
                .toString();
    }
