...
/**
 * Unit tests for DeltaHighlighter which unified the highlighting logic that was previously duplicated in
 * HighlightOriginal/HighlightRevised. These tests verify that the DeltaHighlighter class exists and has the expected
 * API. Testing the full highlighting pipeline requires complex UI setup, so we focus on the class structure and basic
