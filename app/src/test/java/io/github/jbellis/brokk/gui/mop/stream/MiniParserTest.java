...
public class MiniParserTest {
    ...
    /** Test-specific CodeBlockFactory that extracts content from element body rather than data-content attribute */
    ...
    void testNestedCodeFence() {
        ...
        assertTrue(
                ((MarkdownComponentData) composite.children().get(0)).html().contains("<ul><li>Here is a code block:"));
    ...
    void testMultipleNestedCustomTags() {
        var html = "<div>" + "  <p>First paragraph</p>"
    ...
    void testEditBlockInsideBlockquote() {
        var html = "<blockquote>" + "  <p>Here's an edit block:</p>"
    ...
    void testComponentCreationWithThemes() {
        var html =
                "<div>" + "  <code-fence data-id=\"123\" data-lang=\"java\" data-content=\"testTheme();\"/>" + "</div>";
        var doc = Jsoup.parse(html);
    ...
    void idUnchangedWhenContentBelowChanges() {
        ...
        assertEquals(idBefore, idAfter, "Id of unchanged paragraph must stay the same when text is inserted above");
    }
