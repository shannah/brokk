...
/**
 * Tests that verify the multi-line deletion synchronization fix.
 * These tests demonstrate the specific scenario where "deleting lines it deletes more
 * characters on the next line" during direct editor typing with multiline deletions.
 *
 * The fix ensures that REMOVE operations always use fallback synchronization
 * to prevent data corruption when documents are out of sync.
 */
class MultiLineDeletionSyncTest {
    ...
    void testEdgeCaseWithDifferentSizes() throws Exception {
        ...
        String largeContent = "This is a much longer document\nwith multiple lines\nand different content\nthat should be replaced";
        ...
        assertEquals(smallContent, finalDestContent,
            "Destination should match source content after fallback sync");

    }

    /**
     * Simulates the new REMOVE handling logic from the fix/document-synchronization branch.
     * This is the core of our fix: always use fallback for REMOVE operations.
     */
