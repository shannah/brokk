...
class BrokkMarkdownExtensionTest {
    ...
    void mixedCodeFenceAndEditBlocksAreRenderedCorrectly() {
        ...
        assertEquals(2, html.split("<code-fence").length - 1, "should create exactly two <code-fence> elements");
        assertEquals(1, html.split("<edit-block").length - 1, "should create exactly one <edit-block> element");
    ...
    void realWorldEditBlocksGetsRenderedCorrectly3() {
        ...
        assertTrue(
                html.contains("<code>MarkdownOutputPanel.updateLastMessage</code>"), "Inline code should be preserved");
        assertTrue(html.contains("<code>IncrementalBlockRenderer</code>"), "Inline code should be preserved");
    ...
    void rawHtmlIsEscapedWhenEscapeHtmlFlagSet() {
        ...
        assertTrue(html.contains("&lt;div class=&quot;note&quot;&gt;"), "Escaped <div> should be present");
        ...
        assertTrue(html.contains("<strong>Markdown</strong>"), "Markdown-generated <strong> should remain");
    }
