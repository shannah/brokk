...
class ExceptionReporterAsyncTest {
    ...
    /** Test spy implementation that records all calls to reportClientException */
    private static class TestServiceSpy extends Service {
        private final List<ServiceCall> calls = new ArrayList<>();
        private final AtomicInteger callCount = new AtomicInteger(0);
        private boolean shouldFail = false;
        private final ObjectMapper objectMapper = new ObjectMapper();

        public TestServiceSpy() {
            // Call super with a minimal mock project (won't be used for our tests)
            super(new MinimalMockProject());
        }
        ...
        /** Minimal mock project for test service spy */
