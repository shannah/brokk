...
public class EditBlockUtilsTest {
    ...
    void testFindFileNameNearby() {
        ...
        assertEquals("default.py", findFileNameNearby(new String[] {"<<<<<<< SEARCH"}, 0, Set.of(), "default.py"));
    }
    ...
    void testParserRecognition() {
        ...
        MutableDataSet options = new MutableDataSet().set(Parser.EXTENSIONS, List.of(BrokkMarkdownExtension.create()));
