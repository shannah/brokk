...
/**
 * Decribes a file change. These are currently divided into 3 types: modified, added, and removed. We currently
 * ignore the concept of a "moved" file as this would require perhaps some kind of event hook or origin analysis.
 */
